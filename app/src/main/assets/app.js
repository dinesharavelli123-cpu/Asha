...
(()=>{
  ...
  const finishLayers=async()=>{await load('profile_sync.js');try{window.ashaApplyLocalProfile?.()}catch(e){}await load('real_data.js');await load('sleep_calm.js');await load('motion_fx.js');await load('playful_fx.js');await load('mental_tests.js');await load('ai_assistant.js')};
